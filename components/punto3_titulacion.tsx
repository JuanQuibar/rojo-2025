        ...
        <section id="punto3" className="mb-16 scroll-mt-24">
            ...
            <div className='mb-16'>
                ...
                <div className="space-y-4">
                    ...
                    <details><summary>INTRIGA (Promesa de Revelación)</summary><p className="details-content">Para generar curiosidad y la necesidad de saber más. Planteá una pregunta o un misterio relevante.<br/><em>Ejemplo: La dura condena que recibió el hombre que mató a su vecino en Palmares por la música.</em></p></details>
