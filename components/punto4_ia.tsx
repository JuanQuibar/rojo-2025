const Punto4_IA = () => {
    return (
      <section id="punto4" className="min-h-[50vh] flex items-center justify-center text-center scroll-mt-24">
        <div>
          <p className="section-subtitle">PUNTO 4: EL MÉTODO</p>
          <h2 className="mt-2 text-gray-400">Potenciar el SEO con Inteligencia Artificial</h2>
          <p className="text-gray-500 mt-4">Contenido en desarrollo...</p>
