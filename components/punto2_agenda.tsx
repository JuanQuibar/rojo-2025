  ...
  return (
    <section id="punto2" className="mb-16 scroll-mt-24">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-center text-lg text-text-secondary max-w-4xl mx-auto mt-4">Adoptamos un modelo analítico y deliberado para interpretar la realidad, jerarquizarla y construir una agenda con una intención clara: conectar profundamente con nuestro modelo de lector.</p>
      </div>
      ...
      <div className="mb-16">
        ...
        <p className="text-center text-text-secondary max-w-3xl mx-auto mb-12"><span className='font-bold'>Antes de encar una nota,</span> cada tema potencial debe pasar por este filtro de tres fases para determinar su verdadero valor para nuestra portada.</p>
        ...
        <div className="card p-6">
                    ...
                    <div className="grid md:grid-cols-1 gap-4">
                        <div>
                            ...
                            <p className="text-text-secondary ml-4"><strong className="text-text-primary">Prioridad 1:</strong> Persona. La gente conecta con gente. Buscá siempre el rostro humano delante o detrás del hecho.</p>
                ...
                <div className="card p-6">
                    ...
                    <p className="text-text-secondary ml-4">Clasificá el tema según el impacto social, político, económico o cultural que produce.</p>
